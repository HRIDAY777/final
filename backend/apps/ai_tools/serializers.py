    ...
    def validate_model_config(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Model configuration must be a valid JSON object."
            )
        return value
...
class AIQuizGeneratorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'ai_model', 'generation_params', 'is_generated',
            'generation_status', 'generated_at', 'created_by', 'shared_with',
            'created_at', 'updated_at',
...
class AILessonSummarizerSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'title', 'lesson', 'subject', 'summary_type',
            'summary_content', 'key_points', 'vocabulary', 'ai_model',
            'generation_params', 'readability_score', 'coherence_score',
    ...
    def validate_key_points(self, value):
        ...
        if not isinstance(value, list):
            raise serializers.ValidationError(
                "Key points must be a valid JSON array."
            )
        return value
...
class AIPerformancePredictorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'confidence_level', 'confidence_score', 'input_features',
            'feature_importance', 'ai_model', 'generation_params',
            'recommendations', 'intervention_needed', 'intervention_urgency',
            'actual_value', 'prediction_accuracy', 'academic_year',
    ...
    def validate_input_features(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Input features must be a valid JSON object."
            )
        return value
    ...
    def validate_feature_importance(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Feature importance must be a valid JSON object."
            )
        return value
    ...
    def validate_recommendations(self, value):
        ...
        if not isinstance(value, list):
            raise serializers.ValidationError(
                "Recommendations must be a valid JSON array."
            )
        return value
...
class AIAttendanceAnomalyDetectorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'confidence_score', 'detection_date', 'attendance_rate',
            'historical_average', 'deviation', 'contributing_factors',
            'pattern_analysis', 'peer_comparison', 'ai_model',
            'detection_params', 'recommendations', 'intervention_needed',
            'intervention_actions', 'is_resolved', 'resolution_date',
            'resolution_notes', 'created_at', 'updated_at',
            'attendance_rate_display', 'deviation_display'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def validate_contributing_factors(self, value):
        ...
        if not isinstance(value, list):
            raise serializers.ValidationError(
                "Contributing factors must be a valid JSON array."
            )
        return value
    ...
    def validate_pattern_analysis(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Pattern analysis must be a valid JSON object."
            )
        return value
    ...
    def validate_peer_comparison(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Peer comparison must be a valid JSON object."
            )
        return value
    ...
    def validate_intervention_actions(self, value):
        ...
        if not isinstance(value, list):
            raise serializers.ValidationError(
                "Intervention actions must be a valid JSON array."
            )
        return value
...
class AINaturalLanguageQuerySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'user', 'query_text', 'query_type', 'intent',
            'processed_query', 'sql_query', 'parameters', 'result_data',
            'result_summary', 'visualization_config', 'ai_model',
            'processing_params', 'processing_time', 'confidence_score',
            'accuracy_score', 'status', 'error_message', 'user_rating',
            'user_feedback', 'created_at', 'updated_at',
            'processing_time_display', 'confidence_score_display'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def validate_processed_query(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Processed query must be a valid JSON object."
            )
        return value
    ...
    def validate_result_data(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Result data must be a valid JSON object."
            )
        return value
    ...
    def validate_visualization_config(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Visualization config must be a valid JSON object."
            )
        return value
...
class AITrainingJobSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AITrainingJob
        fields = [
            'id', 'name', 'description', 'ai_model', 'training_config',
            'dataset_config', 'status', 'progress', 'current_epoch',
            'total_epochs', 'training_metrics', 'validation_metrics',
            'final_metrics', 'started_at', 'completed_at', 'duration',
            'gpu_usage', 'memory_usage', 'error_message', 'logs',
            'created_by', 'created_at', 'updated_at', 'progress_display',
            'duration_display'
        ]
        read_only_fields = [
    ...
    def validate_training_config(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Training config must be a valid JSON object."
            )
        return value
    ...
    def validate_dataset_config(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Dataset config must be a valid JSON object."
            )
        return value
    ...
    def validate_training_metrics(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Training metrics must be a valid JSON object."
            )
        return value
    ...
    def validate_validation_metrics(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Validation metrics must be a valid JSON object."
            )
        return value
    ...
    def validate_final_metrics(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Final metrics must be a valid JSON object."
            )
        return value
...
class AIDataSourceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'schema_config', 'data_quality_score', 'last_updated',
            'record_count', 'is_active', 'created_by', 'shared_with',
            'created_at', 'updated_at', 'data_quality_score_display'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at']
    ...
    def validate_connection_config(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Connection config must be a valid JSON object."
            )
        return value
    ...
    def validate_schema_config(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Schema config must be a valid JSON object."
            )
        return value
...
class AIUsageLogSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = AIUsageLog
        fields = [
            'id', 'user', 'tool_type', 'input_data', 'output_data',
            'processing_time', 'success', 'error_message', 'user_satisfaction',
            'ai_model', 'model_version', 'ip_address', 'user_agent',
            'session_id', 'timestamp', 'processing_time_display'
        ]
    ...
    def validate_output_data(self, value):
        ...
        if not isinstance(value, dict):
            raise serializers.ValidationError(
                "Output data must be a valid JSON object."
            )
        return value
...
class QuizGenerationSerializer(serializers.Serializer):
    ...
    difficulty = serializers.ChoiceField(
        choices=AIQuizGenerator.DIFFICULTY_CHOICES, default='medium'
    )
    ...
    def validate_content_source(self, value):
        ...
        if not value.strip():
            raise serializers.ValidationError(
                "Content source cannot be empty."
            )
        return value
...
class LessonSummarizationSerializer(serializers.Serializer):
    ...
    summary_type = serializers.ChoiceField(
        choices=AILessonSummarizer.SUMMARY_TYPES, default='detailed'
    )
    ai_model_id = serializers.UUIDField(required=False, allow_null=True)
...
class PerformancePredictionSerializer(serializers.Serializer):
    ...
    prediction_type = serializers.ChoiceField(
        choices=AIPerformancePredictor.PREDICTION_TYPES
    )
    ai_model_id = serializers.UUIDField(required=False, allow_null=True)
...
class NaturalLanguageQuerySerializer(serializers.Serializer):
    ...
    query_type = serializers.ChoiceField(
        choices=AINaturalLanguageQuery.QUERY_TYPES, default='general'
    )
    ai_model_id = serializers.UUIDField(required=False, allow_null=True)
...
class AIAnalyticsSerializer(serializers.Serializer):
    ...
    class Meta:
        fields = [
            'total_models', 'active_models', 'models_by_type',
            'average_accuracy', 'total_queries', 'successful_queries',
            'average_processing_time', 'user_satisfaction', 'recent_activity'
        ]
