...
from .serializers import (
    AIModelSerializer, AIModelCreateSerializer, AIQuizGeneratorSerializer,
    AIQuizGeneratorCreateSerializer, AIQuestionSerializer,
    AILessonSummarizerSerializer, AIPerformancePredictorSerializer,
    AIAttendanceAnomalyDetectorSerializer, AINaturalLanguageQuerySerializer,
    AITrainingJobSerializer, AIDataSourceSerializer, AIUsageLogSerializer,
    QuizGenerationSerializer, LessonSummarizationSerializer,
    PerformancePredictionSerializer, NaturalLanguageQuerySerializer,
    TrainingJobCreateSerializer, AIAnalyticsSerializer
)
...
class AIModelViewSet(viewsets.ModelViewSet):
    ...
    def analytics(self, request):
        ...
        models_by_type = AIModel.objects.values('model_type').annotate(
            count=Count('id')
        )
        ...
        data = {
            ...
            'models_by_type': {
                item['model_type']: item['count'] for item in models_by_type
            },
...
class AIQuizGeneratorViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = [
        'difficulty', 'is_generated', 'generation_status', 'subject'
    ]
    ...
    def generate(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AIQuizGeneratorSerializer(quiz).data,
...
class AILessonSummarizerViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = [
        'summary_type', 'is_generated', 'generation_status', 'subject'
    ]
    ...
    def summarize(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AILessonSummarizerSerializer(summarizer).data,
                status=status.HTTP_201_CREATED
            )
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class AIPerformancePredictorViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = [
        'prediction_type', 'confidence_level', 'intervention_needed', 'subject'
    ]
    ...
    def predict_performance(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AIPerformancePredictorSerializer(predictor).data,
                status=status.HTTP_201_CREATED
            )
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class AINaturalLanguageQueryViewSet(viewsets.ModelViewSet):
    ...
    def query(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AINaturalLanguageQuerySerializer(query).data,
                status=status.HTTP_201_CREATED
            )
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
    ...
    def rate(self, request, pk=None):
        ...
        return Response(
            {'error': 'Invalid rating'}, status=status.HTTP_400_BAD_REQUEST
        )
...
class AITrainingJobViewSet(viewsets.ModelViewSet):
    ...
    def create_job(self, request):
        ...
        if serializer.is_valid():
            ...
            return Response(
                AITrainingJobSerializer(job).data,
                status=status.HTTP_201_CREATED
            )
        return Response(serializer.errors, status=status.HTTP_400_BAD_REQUEST)
...
class AIUsageLogViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def analytics(self, request):
        ...
        data = {
            ...
            'recent_activity': {
                item['tool_type']: item['count'] for item in recent_activity
            }
        }
